...
import vn.eshopvn.entity.DeliveryInfo;
import vn.eshopvn.entity.Order;
import vn.eshopvn.entity.OrderDetail;
import vn.eshopvn.entity.OrderDetailId;
...
@WebServlet(urlPatterns = {"/user/orders", "/user/order/make", "/user/order/detail", "/user/order/setStatus"})
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (session.getAttribute("account") == null) {
	        ...
	        if ("VNPAY".equals(paymentMethod)) {
	        	order.setOstatus(OrderStatus.paid);
	        }else {
