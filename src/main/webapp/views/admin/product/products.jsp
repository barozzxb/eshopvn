						...
						<c:forEach items="${listprod}" var="prod">
							<tr>
								...
								<td class="col-md-2 text-center py-3">
									<div class="price">
										<p id="price"><fmt:formatNumber
								value="${prod.pprice}" type="number" currencySymbol="" /> vnđ</p>
									</div>
								</td>
            ...
            <div class="modal-body">
                <form action="${pageContext.request.contextPath }/admin/product/add" method="post" enctype="multipart/form-data">
                    <div class="form-group">
						...
						<input type="text" class="form-control" id="pmanufacturer" placeholder="Enter Product Manufacturer" name="pmanufacturer"> 
