					...
					<form action="${pageContext.request.contextPath }/admin/genre/edit"
						...
						<div class="form-group">
							...
							<input type="text"
								...
								placeholder="" name="gid" value="${genre.gid }" readonly>
							...
							<input type="text"
								...
								class="info-title" for="gdescription">Genre Description <span>*</span></label>
							<textarea class="form-control unicase-form-control text-input"
								id="gdescription" placeholder="" name="gdescription" rows=20>${genre.gdescription }</textarea>
